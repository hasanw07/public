...
(function ($) {
  ...
  $.fn.idleTimeout = function (userRuntimeConfig) {
    ...
    var defaultConfig = {
	  ...
	  //20200714-Added by Hasan widjaya-Start
      dialogPriorLogout: false,   //set to true if final message want to appear before logout or close tab
      dialogPriorTitle: 'Session Expired', // also displays on browser title bar
      dialogPriorText: 'Your session has timed out.',
      dialogPriorExit: 'Exit',
	  //20200714-Added by Hasan widjaya-End
    ...
    //##############################
      ...
      forceTimeout = false,  //20201407-Added by Hasan Widjaya
    ...
    checkIdleTimeout = function () {
      ...
      if(forceTimeout) return;  //20200714-Added by Hasan
    ...
    logoutUser = function () {
	  ...
	  //20200714-Modified by Hasan Widjaya-Start
      if (currentConfig.dialogPriorLogout){
        forceTimeout = true;
        destroyWarningDialog();
        stopDialogTimer();
    
        var dialogContent = "<div id='idletimer_final_dialog'><p>" + currentConfig.dialogPriorText + "</p></div>";

        $(dialogContent).dialog({
          buttons: [{
            text: currentConfig.dialogPriorExit,
            click: function () {
          ...
          closeOnEscape: false,
          modal: true,
          title: currentConfig.dialogPriorTitle,
          open: function () {
            $(this).closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
          }
        });
		...
		//20200714-Modified by Hasan Widjaya-End
      }
    };
